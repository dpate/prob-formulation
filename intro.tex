...
\subsection{Specific vs Fundamental Problem Formulation }
    ...
    Figure \ref{f:sellar graph} depicts the Sellar problem given by 
    Eq.~\ref{eqn:simple_fpf} in the graph-based syntax which will be presented 
    in this paper. This example will serve to highlight the features of the 
