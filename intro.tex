...
\section{Specific vs Fundamental Problem Formulation }
    ...
    of which MDAO framework, optimization algorithm, iterative solver, or execution sequence
    is used to solve the problem. However, it is very easy to formulate a problem without 
...
\section{Existing Graph-Based Syntax}
    ...
    in FDT in Fig. \ref{fig:FDT_simple} alone. This missing information means 
    ...
    ordering and partitioning algorithms on an MDAO test problem named the 
    ...
    Although XDSM captures part of the functional aspects of FDT, it 
    ...
    Of all the methods, REMS comes the closest to fully describing a fundamental 
    problem formulation, but lacks the ability to represent optimziers and 
    solvers in more specific problem formulations. While XDSM does include 
    optimizers and constraints, it relies on their presence and can't be used 
