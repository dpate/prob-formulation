...
\section{Syntax Definition}
  ...
  For a \emph{directed graph*}((DJP: why the asterisk?)) (or \emph{digraph}) we construct $E$ as a set of ordered pairs instead 
...
\subsection{indegree and outdegree}
  ...
  example, in a sequential optimization in which a global optimizer is applied first ((BG: first and second?))
  and a gradient based optimizer is applied second, design variables would have incomming 
