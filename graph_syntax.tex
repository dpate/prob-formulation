...
Only the variable, model, and expression nodes are allowed to be used in an MCG or FPF. 
All four nodes are required for any SPF. In addition to the three node types, there are two edge types: 
